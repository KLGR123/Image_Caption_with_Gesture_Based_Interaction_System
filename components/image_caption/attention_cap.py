...
def visualize_att(image_path, seq, alphas, rev_word_map, smooth=True):
    ...
    for t in range(len(words)):
        ...
        plt.axis('off')
    # plt.show()
    plt.savefig('./res/res.png', bbox_inches='tight')

    return res


def image_caption_predict(encoder, decoder, img_path, word_map, rev_word_map, beam_size):
    # Encode, decode with attention and beam search
    seq, alphas = caption_image_beam_search(encoder, decoder, img_path, word_map, beam_size)
    alphas = torch.FloatTensor(alphas)

    # Visualize caption and attention of best sequence
    res = visualize_att(img_path, seq, alphas, rev_word_map)
    return res
